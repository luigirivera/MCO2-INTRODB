...
public class ConsumerProductTableModel extends DefaultTableModel {
	private static final long serialVersionUID = 1L;
	private List<Product> products;
	
	public ConsumerProductTableModel(List<Product> products)
	{
	...
	public Object getValueAt(int row, int col)
	{
		...
		case 6: return product.getDiscount();
		case 7: return product.getPrice();
		case 8: return product.getShipping();
		default: return "??";
		}
